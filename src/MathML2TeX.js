...
const MathSymbol = {
  ...
  relation: {
    decimals: [
      ...
      8840, 8841, 8771, 8872, 8713, 8847, 8848, 126, 8764, 8869, 8739, 8849,
      8850, 8733, 8826, 8827, 10927, 10928, 8800, 8738, 8737,
    ],
    scripts: [
      "<",
      ">",
  ...
  binaryOperation: {
    decimals: [
      43, 45, 177, 8745, 8900, 8853, 8723, 8746, 9651, 8854, 215, 8846, 9661,
      8855, 247, 8851, 9667, 8856, 8727, 8852, 9657, 8857, 8902, 8744, 9711,
      8728, 8224, 8743, 8729, 8726, 8225, 8901, 8768, 10815,
    ],
    scripts: [
      "+",
      "-",
  ...
  setAndLogic: {
    decimals: [
      ...
      10233, 8835, 8596, 8712, 10234, 8713, 8660, 8715, 8868, 8743, 8869, 8744,
      8709, 8709,
    ],
    scripts: [
      "\\exists",
  ...
  delimiter: {
    decimals: [
      124, 8739, 8214, 47, 8726, 123, 125, 10216, 10217, 8593, 8657, 8968, 8969,
      8595, 8659, 8970, 8971,
    ],
    scripts: [
      "|",
  ...
  greekLetter: {
    decimals: [
      913, 945, 925, 957, 914, 946, 926, 958, 915, 947, 927, 959, 916, 948, 928,
      960, 982, 917, 1013, 949, 929, 961, 1009, 918, 950, 931, 963, 962, 919,
      951, 932, 964, 920, 952, 977, 933, 965, 921, 953, 934, 981, 966, 922, 954,
  ...
  other: {
    decimals: [
      8706, 305, 8476, 8711, 8501, 240, 567, 8465, 9723, 8502, 8463, 8467, 8472,
      8734, 8503,
    ],
    scripts: [
      "\\partial",
